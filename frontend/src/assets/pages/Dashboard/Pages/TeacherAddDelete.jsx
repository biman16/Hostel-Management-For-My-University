  ...
  return (
    <div>
        ...
        <div className=' flex items-center justify-between'>
            ...
            <div className='flex-1 text-center font-bold text-[#1F4B5E] md:text-[50px]'>Manage Teachers</div>
        </div>
        ...
        <div className='w-full flex justify-center mt-10'>
            <div className='w-[90%] md:w-[90%] bg-gray-200 rounded-[40px] shadow-xl p-8'>
                ...
                <div className='flex flex-col w-full'>
                    <label className='text-[20px] md:text-[24px] font-semibold mb-2'>Teacher Username</label>
                    <input type="text"
        ...
        <div className='w-full flex justify-center mt-20'>
            <div className='w-[90%] md:w-[90%] bg-gray-200 rounded-[40px] shadow-xl p-8'>
                <div className=''>
                    <div className='text-center text-[20px] md:text-[24px] font-semibold'>List Of Teachers</div>
...
export default TeacherAddDelete